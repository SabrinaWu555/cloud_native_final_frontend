...
export const ENDPOINTS = {
  ...
  vendorOrders: process.env.VENDOR_ORDERS_PATH || "/vendor/orders",
  ...
  billingStatementsByUser: process.env.BILLING_STATEMENTS_BY_USER_PATH || "/statements/user/:id",
  billingIncidents: process.env.BILLING_INCIDENTS_PATH || "/billing/incidents",
  billingIncidentsByUser: process.env.BILLING_INCIDENTS_BY_USER_PATH || "/incidents/user/:id",
};
